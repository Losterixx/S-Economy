...
object RegisterManager {
    ...
    private fun registerCommands() {
        ...
        if (getCommands().getBoolean("balancetop.enabled")) registerCommand("balancetop", BalanceTopCommand(), null, *getCommands().getStringList("balancetop.aliases").toTypedArray())
